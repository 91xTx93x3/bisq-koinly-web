...
test("detecta duplicados y detalles desconocidos", () => {
...
test("rechaza columnas obligatorias ausentes", () => {
  assert.throws(() => convertFiles("Trade ID\nx\n", transactions), /faltan columnas/);
});
